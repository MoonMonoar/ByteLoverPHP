...
console.log('%cDO NOT PASTE ANYTHING FROM ANYONE AND DO NOT SHARE ANY INFORMATION TO ANYONE. IF YOU DO, YOU MAY LOOSE ACCESS TO YOUR ACCOUNT!', 'color: red; font-size: 18px;');
...
const prompt_dismiss = () => {
    ...
    setTimeout(() => {
        $("#mask, #prompt").remove();
        $("html").css("overflow", "");
        $("html").removeClass("p-h-p");
        $("header").removeClass("p-h-w");
    }, 30);
};
const stop_prop = (e) => {
    e.stopPropagation();
