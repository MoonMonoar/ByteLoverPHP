...
<html>
    <head>
        <title><?php echo $strings["page_student_dashboard"][$lang];?></title>
        <?php
    ...
    <body>
        <header>
            <div class="pad header_divs">
                ...
                <div class="ml12">
                    ...
                    <div class="ml12">
                            <button class="ub cflex" onclick="logout_app()" title="<?php echo $strings["logout"][$lang];?>">
                                <span><?php echo $strings["logout"][$lang];?></span><i class="fa-solid fa-power-off"></i>
                            </button>
                    </div>
                    
                    <div class="ml12">
                        <button onclick="notifs()" class="ub cflex"><span><?php echo $strings["notifications"][$lang];?></span></span><i class="fa fa-bell"></i>
                        </button>
                    </div>
        ...
        <script src="/js/min/dashboard.js?v=<?php echo $script_version;?>"></script>
